...
// Import Banner Img
import img_banner from '../../../assets/img/home-one-banner/1.png'
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div className="home-one-banner-content">
                                ...
                                <p>
                                    Thinkorswim is the best charting and analysis platform out there, but it is not complete.
                                    Allow us to give you the extra tools to make your trading career a success.
                                    Made by traders for traders.
                                </p>
                                <ModalVideo channel='youtube' api={false} autoplay isOpen={isOpen} videoId="0RImWkNyids"
